...
namespace SimpleL7Proxy.Backends
{
    public class Backends : IBackendService
    {
        private List<BackendHost.BackendHost> _hosts;
        private List<BackendHost.BackendHost> _activeHosts;

        private BackendOptions.BackendOptions _options;
        ...
        public Backends(IOptions<BackendOptions.BackendOptions> options)
        {
            ...
            _hosts = bo.Hosts;
            _options = bo;
            _activeHosts = new List<BackendHost.BackendHost>();
        ...
        public List<BackendHost.BackendHost> GetActiveHosts()
        {
            return _activeHosts;
        }
